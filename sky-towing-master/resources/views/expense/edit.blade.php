    ...
    <div class="row">
        ...
        <div class="card col-md-8">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" method="post" action="{{ route('expenses.update', $expense->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="detail" class="form-control" name="detail"
                                            value="{{ $expense->detail }}" placeholder="text" fdprocessedid="txd1tt">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="unit" class="form-control" name="unit"
                                            value="{{ $expense->unit }}" placeholder="number" fdprocessedid="y1y86g">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="unit_price" class="form-control" name="unit_price"
                                            value="{{ $expense->unit_price }}" placeholder="number" fdprocessedid="tyl3a">
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-success me-1 mb-1" fdprocessedid="u0hyba">Update
                                    </button>
