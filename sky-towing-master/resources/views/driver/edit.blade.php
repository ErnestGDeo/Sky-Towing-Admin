...
@section('content')
    <div class="raw">
        <div class="card cal-md-8">
            <div class="card-header">
                <h4 class="card-title">Driver</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('drivers.update', $driver->id) }}" method="POST"
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first-name-vertical" class="form-control" name="name"
                                               value="{{ $driver->name }}" placeholder="Input Nama"
                                               fdprocessedid="k23n1o">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="email-id-vertical">Phone
                                            <x-required-field/>
                                        </label>
                                        <input type="text" id="email-id-vertical" class="form-control" name="phone"
                                               value="{{ $driver->phone }}" placeholder="Phone" fdprocessedid="txd1tt">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email-id-vertical" class="form-control" name="email"
                                               value="{{ $driver->email }}" placeholder="E-mail" fdprocessedid="txd1tt">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="contact-info-vertical" class="form-control"
                                               name="address"
                                               value="{{ $driver->address }}" placeholder="Alamat"
                                               fdprocessedid="y1y86g">
                                    </div>
                                </div>
                                <div class="col-12">
                                    ...
                                    @foreach (\App\Enums\DriverRole::asSelectArray() as $value => $key)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="role"
                                                   @checked($value == $driver->role) id="{{ $key . $value }}"
                                                   value="{{ $value }}">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="form-select" id="basicSelect" name="sim_type">
                                                ...
                                                @foreach (\App\Enums\SimType::asSelectArray() as $key => $value)
                                                    <option @selected($value == $driver->sim_type) value="{{ $value }}">
                                                        {{ $value }}</option>
                                                @endforeach
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="first-name-vertical" class="form-control"
                                               ...
                                               value="{{ $driver->expired_at->format('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                  name="note">{{ $driver->note }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    ...
                                    <button type="reset" class="btn btn-light-secondary me-1 mb-1" fdprocessedid="3tnbn">
                                        Reset
                                    </button>
                                </div>
                            </div>
