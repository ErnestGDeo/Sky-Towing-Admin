            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="{{ route('profits.update', $profit->id) }}"
                                  method="POST">
                                @csrf
                                @method('put')
                                            ...
                                            <fieldset class="form-group">
                                                <select class="choices form-select choices__input" id="vehicle_type"
                                                    ...
                                                    @foreach (\App\Enums\VehicleType::asSelectArray() as $value => $key)
                                                        <option
                                                            @selected($value == $profit->vehicle_type) value="{{ $value }}">
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="vehicle_description" class="form-control"
                                                   name="vehicle_description" value="{{ $profit->vehicle_description }}"
                                                   placeholder="Description" fdprocessedid="mjec4q">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name=payment_method"" id="" class="form-control">
                                                <option
                                                    value="transfer" @selected($profit->payment_method == 'transfer')>
                                                    Transfer
                                                </option>
                                                <option value="cash"
                                                    @selected($profit->payment_method == 'cash')>Cash
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                   name="office" placeholder="Office" fdprocessedid="vdxz">
                                        </div>
                                    </div>
