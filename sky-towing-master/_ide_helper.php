...
namespace  { 
             ...
             * @see \App\Providers\MacroServiceProvider::builderMacros()
             * @static 
             */ 
            public static function contains($columns, $value)
            {
                                return \Illuminate\Database\Eloquent\Builder::contains($columns, $value);
            }
